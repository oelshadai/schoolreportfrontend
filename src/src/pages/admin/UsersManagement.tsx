...
const UsersManagement = () => {
  ...
  const stats = [
    ...
    { label: 'Active Users', value: mockUsers.filter(u => u.status === 'active').length, color: 'from-green-500 to-emerald-500' },
    { label: 'Inactive Users', value: mockUsers.filter(u => u.status === 'inactive').length, color: 'from-orange-500 to-red-500' },
    { label: 'Super Admins', value: mockUsers.filter(u => u.role === 'SUPER_ADMIN').length, color: 'from-purple-500 to-pink-500' },
  ];
